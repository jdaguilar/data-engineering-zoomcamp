...
google_storage_bucket.data-lake-bucket: Creation complete after 0s [id=dtc_data_lake_****************]
google_bigquery_dataset.dataset: Creation complete after 1s [id=projects/****************/datasets/trips_data_all]

Apply complete! Resources: 2 added, 0 changed, 0 destroyed.
```

**Note: GCP Project ID has been hidden by security reasons.**